    ...
    <div>
      ...
      <div className='grid grid-cols-4 gap-5 mt-10'>
        {projects.map((project) => (
          <div key={project._id} className='flex flex-col gap-1 border border-solid border-gray-400 rounded-md p-2 cursor-pointer'
          ...
          >
            ...
            <div className='flex justify-between'>
              ...
              <span className='text-gray-600 text-sm uppercase'>{project.owner.firstName}</span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-600 text-sm font-semibold'>Status</span>
              <span className='text-gray-600 text-sm uppercase'>{project.status}</span>
            </div>
          </div>
        ))}
      </div>
